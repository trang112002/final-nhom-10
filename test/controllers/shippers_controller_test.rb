...
class ShippersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipper" do
    assert_difference("Shipper.count") do
      post shippers_url, params: { shipper: { company: @shipper.company, name: @shipper.name, phone: @shipper.phone, rating: @shipper.rating } }
    end
  ...
  test "should update shipper" do
    patch shipper_url(@shipper), params: { shipper: { company: @shipper.company, name: @shipper.name, phone: @shipper.phone, rating: @shipper.rating } }
